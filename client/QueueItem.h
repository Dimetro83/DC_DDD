...
public:
	...
	// [+]PVS	V801	Decreased performance. It is better to redefine the fourth function argument as a reference. Consider replacing 'const .. partialSource' with 'const .. &partialSource'.	client	queueitem.cpp	103	False	
