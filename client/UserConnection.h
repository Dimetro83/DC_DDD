...
public:
	...
	// NMDC stuff
	void myNick(const string& aNick) { send("$MyNick " + Text::fromUtf8(aNick, m_last_encoding) + '|'); } //TODO crash-strong-full-r6730-x64.dmp
...
private:
	...
	UserConnection(bool secure_) noexcept : m_last_encoding(Text::systemCharset), state(STATE_UNCONNECTED),
