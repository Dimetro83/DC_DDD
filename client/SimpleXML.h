...
public:
	...
	string getChildAttribTrim(const string& aName, const string& aDefault = Util::emptyString) throw(SimpleXMLException) //[+]PPA
	{
	 ...
	 * was not needed...
	 */
	static bool needsEscape(const string& aString, bool aAttrib, bool aLoading = false, const string &encoding = Text::g_utf8) {
