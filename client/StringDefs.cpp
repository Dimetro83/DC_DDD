...
"Forbidden", 
"Force attempt", 
"Confirm sending crash stack dump to developers", 
...
"Run in background", 
"Statistics", 
"Please wait while DDD++ indexes your files (they won't be shared until they've been indexed)...", 
...
"left", 
"Left color", 
"Application ""%s"" caused an unhandled exception in DDD++. Please uninstall it, upgrade it or use an alternate product.", 
"Upload Limit", 
"File list loaded.", 
"Loading DDD++, please wait...", 
...
"File Size:", 
"A MAGNET link was given to DDD++, but it didn't contain a valid file hash for use on the Direct Connect network.  No action will be taken.", 
"DDD++ has detected a MAGNET link with a file hash that can be searched for on the Direct Connect network.  What would you like to do?", 
...
"Dcsite", 
"DC++ Help"
"Yaroslavl.Biz DC++ magnet portal"
"Hublist SVAO-IX", 
"Hublist HOME-IX", 
"Hublist NetByNet", 
"Hublist Triolan", 
...
"None", 
"Normal", 
"Not listening for connections - please restart DDD++", 
"Notepad", 
"segment(s)", 
"Offline", 
"OK", 
...
"* Minimal upload limit is set to 5Чslots + 4 !!!", 
...
"Remove Forbidden (Unfinished Kazaa, Win MX, GetRight, eMule, DDD++)", 
...
"Don't announce new DDD++ versions", 
...
"Queue", 
"Rename", 
"Note; most of these options require that you restart DDD++", 
"Reset", 
