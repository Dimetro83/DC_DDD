...
namespace dht
{
	...
	const uint64_t now = GET_TICK();
		switch(cmd.getCommand())
		{
			...
			const OutPacket p(ip, now, cmd.getCommand());
				sentPackets.push_back(p); // 2012-06-19_23-49-10_YWTRJOWSYIHLW6IS2BQWBKP6I42DMBXH23BMFMY_C102EBEF_crash-strong-stack-r10403.dmp
				break;
		}
