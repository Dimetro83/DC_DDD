...
public :
    ...
    Ztring& From_GUID    (const int128u& S); //[!]PVS-Studio V801	Decreased performance. It is better to redefine the first function argument as a reference. Consider replacing 'const .. S' with 'const .. &S'.
        /// @brief convert an 16 byte UUID into Ztring
    Ztring& From_UUID    (const int128u& S); //[!]PVS-Studio V801	Decreased performance. It is better to redefine the first function argument as a reference. Consider replacing 'const .. S' with 'const .. &S'.
    ...
    Ztring& From_Number  (const int64u,   int8u Radix=10);
        /// @brief convert number into Ztring
    Ztring& From_Number  (const int128u&,  int8u Radix=10); //[!]PVS-Studio V801	Decreased performance. It is better to redefine the first function argument as a reference. Consider replacing 'const .. S' with 'const .. &S'.
    /// @brief convert number into Ztring
    ...
    static Ztring ToZtring  (const int128u&  I, int8u Radix=10)   //[!]PVS-Studio V801	Decreased performance. It is better to redefine the first function argument as a reference. Consider replacing 'const .. S' with 'const .. &S'.
