...
PropPage::Item AdvancedPage::items[] = {
	...
	{ IDC_ISP_RESOURCE_ROOT_URL, SettingsManager::ISP_RESOURCE_ROOT_URL, PropPage::T_STR},
	{ 0, 0, PropPage::T_END }
};
...
AdvancedPage::ListItem AdvancedPage::listItems[] = {
	...
	{ SettingsManager::ENABLE_LAST_IP, ResourceManager::ENABLE_LAST_IP }, //[+]PPA
	{ SettingsManager::SQLITE_USE_JOURNAL_MEMORY, ResourceManager::SQLITE_USE_JOURNAL_MEMORY }, //[+]PPA
//	{ SettingsManager::SQLITE_USE_EXCLUSIVE_LOCK_MODE, ResourceManager::SQLITE_USE_EXCLUSIVE_LOCK_MODE }, //[+]PPA
