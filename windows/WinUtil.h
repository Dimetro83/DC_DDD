...
static const toolbarButton ToolbarButtons[] = {
	...
	{IDC_OPEN_DOWNLOADS, 13, false, ResourceManager::MENU_OPEN_DOWNLOADS_DIR},			// -Damaks- [#] Кнопка "Открыть папку загрузки"
	...
	{IDC_REFRESH_FILE_LIST, 22, false, ResourceManager::MENU_REFRESH_FILE_LIST},			// -Damaks- [+] Кнопка "Обновить шару"
	{IDC_OPEN_MY_LIST, 23, false, ResourceManager::MENU_OPEN_OWN_LIST},			// -Damaks- [+] Кнопка "Посмотреть свой список файлов"
	{ID_FILE_QUICK_CONNECT, 24, false, ResourceManager::MENU_QUICK_CONNECT}			// -Damaks- [+] Кнопка "Быстрое соединение"
};
...
public:
	...
	static int getOsMajor(bool wowver = false);
	static int getOsMinor(bool wowver = false);
    ...
    static int getFlagImage(string& country); //[+]PPA
...
/**
 * @file
 * $Id: WinUtil.h 568 2011-07-24 18:28:43Z bigmuscle $
 */
