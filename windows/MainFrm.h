...
public:
	...
	BEGIN_MSG_MAP(MainFrame)
		...
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE1, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE2, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE3, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE4, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE5, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE6, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE7, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE8, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE9, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE10, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE11, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE12, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE13, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE14, onLink)
		COMMAND_ID_HANDLER(IDC_DCSITE_SITE15, onLink)
		COMMAND_ID_HANDLER(IDC_HELP_HOMEPAGE, onLink)
//		COMMAND_ID_HANDLER(IDC_HELP_SOURCE_CODE, onLink)			// -Damaks- [-]
		COMMAND_ID_HANDLER(IDC_HELP_GEOIPFILE, onLink)
//		COMMAND_ID_HANDLER(IDC_HELP_TRANSLATIONS, onLink)			// -Damaks- [-]
		...
		COMMAND_ID_HANDLER(IDC_REFRESH_FILE_LIST, onRefreshFileList)			// -Damaks- [#]  нопка "ќбновить шару"
...
//#endif
	...
	LRESULT OnFileExit(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/) {
		...
		{
			string const strDowloadDir = SETTING(DOWNLOAD_DIRECTORY);
...
/**
 * @file
 * $Id: MainFrm.h 568 2011-07-24 18:28:43Z bigmuscle $
 */
