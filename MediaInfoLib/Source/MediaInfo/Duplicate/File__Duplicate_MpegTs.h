...
//private :
    ...
    //Configuration
    std::unordered_set<int16u> Wanted_program_numbers;
    std::unordered_set<int16u> Wanted_program_map_PIDs;
    std::unordered_set<int16u> Wanted_elementary_PIDs;
    std::unordered_set<int16u> Remove_program_numbers;
    std::unordered_set<int16u> Remove_program_map_PIDs;
    std::unordered_set<int16u> Remove_elementary_PIDs;
