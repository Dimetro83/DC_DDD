...
void File_Riff::AVI__idx1()
{
    ...
    while (Element_Offset+16<=Element_Size)
    {
        ...
        */
        ...
        Stream[StreamID].StreamSize+=Size;
        Stream[StreamID].PacketCount++;
        Stream_Structure[Idx1_Offset+Offset].Name=StreamID;  // https://www.box.net/shared/6c0783f1b3dce69d0c65
		// 2012-04-29_06-52-32_BM6CDLFRPZIMY7YVEZ7HVHN62UETWVW7PTMHONY_71EB8DE8_crash-stack-r502-beta23-build-9860.dmp
		// 2012-06-09_18-15-11_LDX3BURUYDL5437VHQJUAG5MMBY7AFAUOQ7BS6Y_42462AC9_crash-stack-r501-build-10294.dmp
        Stream_Structure[Idx1_Offset+Offset].Size=Size;
        Element_Offset+=16;
    }
