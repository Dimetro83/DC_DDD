...
int32u Mpeg7_FileFormatCS_termID(MediaInfo_Internal &MI)
{
    ...
    if (Format==_T("JPEG"))
        return 10000;
    if (Format==_T("JPEG 2000") /*|| Format==_T("JPEG 2000") */ ) // //[!]PVS-Studio V501	There are identical sub-expressions 'Format == L"JPEG 2000"' to the left and to the right of the '||' operator.	MediaInfoLib	export_mpeg7.cpp	162	False	
        return 20000;
    if (Format==_T("MPEG Audio"))
