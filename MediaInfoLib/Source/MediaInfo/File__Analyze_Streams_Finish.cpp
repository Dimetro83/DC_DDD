...
void File__Analyze::Streams_Finish_Global()
{
    ...
    Streams_Finish_StreamOnly(); // [!]PVS-Studio  V525	The code containing the collection of similar blocks. Check items 'Streams_Finish_StreamOnly', 'Streams_Finish_InterStreams', 'Streams_Finish_InterStreams', 'Streams_Finish_InterStreams' in lines 52, 54, 56, 58.	MediaInfoLib	file__analyze_streams_finish.cpp	52	False	
